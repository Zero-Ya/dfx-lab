...
const Topbar = () => {
  return (
    <div className="w-screen z-99 p-4 pr-8 pt-4 -mt-4 bg-white fixed flex justify-between items-center">
      ...
      <div className="flex text-[10px] min-[600px]:text-[12px] min-[800px]:text-[16px] min-[1024px]:text-[20px] font-montserrat-semibold items-center gap-4 min-[600px]:gap-6 min-[800px]:gap-10">
