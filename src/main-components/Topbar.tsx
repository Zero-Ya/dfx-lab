...
const Topbar = () => {
  return (
    <div className="w-screen z-99 p-4 pr-8 -mt-4 bg-white fixed flex justify-between items-center">
      <img className='w-auto h-3 min-[400px]:h-4 min-[600px]:h-6 min-[800px]:h-10 min-[1024px]:h-12' src={usf_logo} />

      <div className="flex text-[10px] min-[600px]:text-[12px] min-[800px]:text-[16px] min-[1024px]:text-[20px] font-trade-gothic items-center gap-4 min-[600px]:gap-6 min-[800px]:gap-10">
