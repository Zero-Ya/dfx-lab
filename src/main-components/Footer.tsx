...
const Footer = () => {
  return (
    <>
    <div className="w-full flex flex-col min-[600px]:flex-row font-trade-gothic text-[10px] min-[600px]:text-[10px] min-[800px]:text-[12px] min-[1024px]:text-[16px] text-white gap-6 min-[800px]:gap-12 min-[1024px]:gap-24 justify-between p-6 px-6 min-[600px]:px-8 min-[800px]:px-12 min-[1024px]:px-14 mt-12 min-[600px]:mt-10 min-[800px]:mt-12 min-[1024px]:mt-16 min-[1440px]:mt-24 bg-gray-400">
      <div className="w-full flex justify-between gap-6 min-[800px]:gap-12 min-[1024px]:gap-24">
    ...
    <div className="font-trade-gothic text-[10px] min-[800px]:text-[12px] min-[1024px]:text-[16px] flex justify-center py-6">
      All Rights Reserved
    </div>
    </>
  )
