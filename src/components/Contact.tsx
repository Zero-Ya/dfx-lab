...
const Contact = () => {
  return (
    <>
      <Topbar />
      <div className="flex flex-col font-montserrat items-center text-[10px] min-[600px]:text-[12px] min-[800px]:text-[16px] min-[1024px]:text-[20px] m-4 min-[600px]:px-8 min-[800px]:px-12 gap-4 min-[600px]:gap-6 min-[800px]:gap-8 pt-14 min-[600px]:pt-20 min-[800px]:pt-24">
