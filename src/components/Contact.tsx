...
const Contact = () => {
  return (
    <>
      <Topbar />
      <div className="flex flex-col font-montserrat items-center text-[8px] min-[600px]:text-[10px] min-[800px]:text-[14px] min-[1024px]:text-[18px] m-4 min-[600px]:px-8 min-[800px]:px-12 gap-4 min-[600px]:gap-6 min-[800px]:gap-8 pt-14 min-[600px]:pt-20 min-[800px]:pt-24">
      {/* <hr className="w-full h-[1.5px] bg-black shadow-2xl border-0 rounded-xl"/> */}
        <div className="flex font-montserrat-bold justify-center text-[22px] min-[600px]:text-[26px] min-[800px]:text-[30px] min-[1024px]:text-[34px]">Contact Us</div>
        ...
        <form className="w-4/5 min-[1024px]:w-2/3 min-[1440px]:w-1/2 flex flex-col gap-6 min-[800px]:gap-10 rounded-xl border border-gray-100 p-6 min-[800px]:p-8 min-[1024px]:p-10 shadow-xl">
          <div className="text-[14px] min-[600px]:text-[18px] min-[800px]:text-[22px] min-[1024px]:text-[26px] min-[1440px]:text-[28px]">Send Us a Message</div>
